...
export default function VendorPage() {
  return <main>
    ...
    <section className={`${styles.section} shell`}><div className="section-kicker">Corporate information</div><div className={styles.facts}><div><span>Legal name</span><strong>UNIRAS SDN. BHD.</strong></div><div><span>Registration no.</span><strong>1478108T / 202201032411</strong></div><div><span>Entity</span><strong>Private limited company</strong></div><div><span>Country</span><strong>Malaysia</strong></div><div><span>Primary business</span><strong>Digital products, applications and business systems</strong></div><div><span>General contact</span><strong>uniras.capital@gmail.com</strong></div></div></section>
    ...
    <footer className="footer shell"><div className="brand"><span>UNIRAS</span></div><p>UNIRAS SDN. BHD.<br/>Registration No. 1478108T / 202201032411</p><p>Digital Products | Applications | Business Systems</p><p>© 2026 UNIRAS SDN. BHD.</p></footer>
  </main>;
}
