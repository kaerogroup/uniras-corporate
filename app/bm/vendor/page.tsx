...
export default function VendorMalayPage() {
  return <main>
    ...
    <section className={`${styles.section} ${styles.soft}`}><div className="shell"><div className="section-kicker">Kategori vendor</div><div className={styles.heading}><h2>Perkhidmatan teknologi yang mudah dipetakan oleh perolehan.</h2><p>Kategori menggunakan bahasa perolehan yang lazim supaya UNIRAS boleh diklasifikasikan secara konsisten dalam sistem vendor.</p></div><div className={styles.tags}>{categories.map((item)=><span key={item}>{item}</span>)}</div></div></section>
