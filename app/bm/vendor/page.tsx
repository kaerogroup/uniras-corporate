...
const readiness = [
  ["Maklumat korporat awam", "Sedia", "Nama sah syarikat, nombor pendaftaran, TIN, jenis entiti, negara dan kategori perkhidmatan teknologi diterbitkan di sini."],
...
export default function VendorMalayPage() {
  return <main>
    <header className="site-header shell"><a className="brand" href="/bm" aria-label="Laman utama UNIRAS"><span>UNIRAS</span></a><nav aria-label="Navigasi halaman vendor"><a href="/bm">Profil syarikat</a><span className="language-switch"><a href="/vendor">EN</a><span className="active">BM</span></span></nav></header>
    ...
    <section className={`${styles.section} shell`}><div className="section-kicker">Maklumat korporat</div><div className={styles.facts}><div><span>Nama sah syarikat</span><strong>UNIRAS SDN. BHD.</strong></div><div><span>No. pendaftaran</span><strong>1478108T / 202201032411</strong></div><div><span>TIN</span><strong>C29896459070</strong></div><div><span>Entiti</span><strong>Syarikat sendirian berhad</strong></div><div><span>Negara</span><strong>Malaysia</strong></div><div><span>Perniagaan utama</span><strong>Produk digital, aplikasi dan sistem perniagaan</strong></div><div><span>Maklumat hubungan</span><strong>uniras.capital@gmail.com</strong></div></div><div className="profile-links"><a className="text-link" href="/company-profile-bm.pdf" target="_blank" rel="noreferrer">Profil Syarikat (BM)</a><a className="text-link" href="/company-profile-en.pdf" target="_blank" rel="noreferrer">Company Profile (EN)</a></div></section>
    ...
    <footer className="footer shell"><div className="brand"><span>UNIRAS</span></div><p>UNIRAS SDN. BHD.<br/>No. Pendaftaran 1478108T / 202201032411<br/>TIN C29896459070</p><p>Produk Digital | Aplikasi | Sistem Perniagaan</p><p>© 2026 UNIRAS SDN. BHD.</p></footer>
  </main>;
}
