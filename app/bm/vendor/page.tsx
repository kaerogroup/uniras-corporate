...
export default function VendorMalayPage() {
  return <main>
    ...
    <footer className="footer shell"><div className="brand"><span>UNIRAS</span></div><p>UNIRAS SDN. BHD.<br/>No. Pendaftaran 1478108T / 202201032411</p><p>Produk Digital | Aplikasi | Sistem Perniagaan</p><p>© 2026 UNIRAS SDN. BHD.</p></footer>
  </main>;
}
