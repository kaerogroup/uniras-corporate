...
export default function VendorMalayPage() {
  return <main>
    ...
    <section className={`${styles.section} ${styles.note}`}><div className={`shell ${styles.noteInner}`}><div><div className="section-kicker">Hubungan perolehan</div><h2>Perlu daftarkan UNIRAS dalam sistem vendor anda?</h2><p>Hantar borang pendaftaran, senarai semak dokumen atau keperluan perolehan. Kami akan membalas dengan maklumat korporat berkaitan melalui saluran yang sesuai.</p></div><a className="button primary" href="mailto:uniras.capital@gmail.com?subject=Pendaftaran%20Vendor%20-%20UNIRAS%20SDN.%20BHD.">Minta dokumen vendor</a></div></section>
